...
__all__ = ['DyHeadBlock', 'DyHeadBlockWithDCNV3', 'Fusion', 'C3k2_Faster', 'C3k2_ODConv', 'Partial_conv3', 'C3k2_Faster_EMA', 'C3k2_DBB',
           ...
           'C3k2_FocusedLinearAttention', 'LCSG', 'AKConv', 'C3k2_AKConv',
           ...
           'SEAM', 'MultiSEAM', 'C3k2_SWC', 'C3k2_iRMB',
...
class C3k2_MLCA(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        self.m = nn.ModuleList(
            C3k_MLCA(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_MLCA(self.c, self.c, shortcut, g) for _ in
            range(n))
